...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model,classificationmatric):
        with mlflow.start_run():
            ...
            accuracy_score = classificationmatric.accuracy
    ...
    def train_model(self,X_train,y_train,X_test,y_test):
        ...
        model_trainer_artifact=ModelTrainerArtifact(trained_model_file_path=self.model_trainer_config.trained_model_file_path,
                             train_matric_artifact=classification_train_matric,
                             test_matric_artifact=classification_test_matric
                             )
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            # Loading training and testing data as numpy array
